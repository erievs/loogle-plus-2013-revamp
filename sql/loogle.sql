...
--
-- Host: localhost
-- Generation Time: Sep 15, 2024 at 11:29 PM
...
CREATE TABLE `about_user` (
  ...
  `networking` varchar(100) DEFAULT 'Nothing',
  `birthday` date DEFAULT NULL,
  `relationship` varchar(50) DEFAULT 'Unset',
  `othernames` varchar(255) DEFAULT 'Unset',
...
CREATE TABLE `communities_posts` (
  ...
  `image_link_url` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `post_link_url` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `post_link` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `plus_one_usernames` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
